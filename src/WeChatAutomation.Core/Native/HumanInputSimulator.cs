        ...
        public async Task SendKeysAsync(string keys)
        {
            ...
            foreach (var p in parts)
            {
                switch (p.Trim().ToLower())
                {
                    ...
                    case "insert": case "ins": keyList.Add(User32.VK_INSERT); break;
                    case "f1": keyList.Add(User32.VK_F1); break;
                    case "f2": keyList.Add(User32.VK_F2); break;
                    case "f3": keyList.Add(User32.VK_F3); break;
                    case "f4": keyList.Add(User32.VK_F4); break;
                    case "f5": keyList.Add(User32.VK_F5); break;
                    case "f6": keyList.Add(User32.VK_F6); break;
                    case "f7": keyList.Add(User32.VK_F7); break;
                    case "f8": keyList.Add(User32.VK_F8); break;
                    case "f9": keyList.Add(User32.VK_F9); break;
                    case "f10": keyList.Add(User32.VK_F10); break;
                    case "f11": keyList.Add(User32.VK_F11); break;
                    case "f12": keyList.Add(User32.VK_F12); break;
